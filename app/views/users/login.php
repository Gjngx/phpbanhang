                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="/phpbanhang/public/user/img/sign.jpeg" alt="login form" style="border-radius: 1rem 0 0 1rem; max-width: 115%; height: 100%;" />
                            </div>
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">

                                    <form action="/phpbanhang/user/checklogin" method="post">
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn chưa có tài khoản ? <a href="/phpbanhang/user/register" style="color: #393f81;">Đăng ký tại đây</a></p>
                                    </form>
